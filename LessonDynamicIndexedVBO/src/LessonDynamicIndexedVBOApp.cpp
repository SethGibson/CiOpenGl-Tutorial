...
class LessonDynamicIndexedVBOApp : public AppNative
{
public:
	void setup() override;
...
void LessonDynamicIndexedVBOApp::setup()
{
	try
	{
...
void LessonDynamicIndexedVBOApp::mouseDown( MouseEvent event )
{

}

void LessonDynamicIndexedVBOApp::update()
{

}

void LessonDynamicIndexedVBOApp::draw()
{
...
CINDER_APP_NATIVE( LessonDynamicIndexedVBOApp, RendererGl )
