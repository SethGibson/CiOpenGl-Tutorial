...
class LessonRTT1App : public App
{
public:
	void setup();
...
void LessonRTT1App::setupShadowMap()
{
...
void LessonRTT1App::mouseDrag(MouseEvent event)
{
	mMayaUI.mouseDrag(event.getPos(), event.isLeftDown(), false, event.isRightDown());
}

void LessonRTT1App::renderShadowMap()
{
...
CINDER_APP(LessonRTT1App, RendererGl)
